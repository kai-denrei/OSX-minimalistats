            ...
            case let widget as TextWidget:
                ...
                pairs.forEach { pair in
                    ...
                    case "$capacity":
                        ...
                        case "totalGB": replacement = DiskSize(d.size).gigabytesString
                        case "usedGB": replacement = DiskSize(d.size - d.free).gigabytesString
                        case "freeGB": replacement = DiskSize(d.free).gigabytesString
                        case "compact": replacement = "\(DiskSize(d.size - d.free).gigabytesString)/\(DiskSize(d.size).gigabytesString)GB"
                        default: return
                        }
                    case "$percentage":
                        var percentage: Int
